const en = {
  ...
  noEventsDescription: "Collect sources or hot events, then cluster new articles to create analyzable events.",
  noEventsFiltered: "No matching events. Clear search or filters and try again.",
  noEventSelected: "Select an event to view analysis and source reports.",
  noArticlesTitle: "No reports for this event yet",
  noArticlesDescription: "Run hot-event collection or cluster newly collected articles, then refresh this event.",
  source: "Source",
  ...
  backfillThisArticle: "Refetch this article",
  backfillArticleQueued: "Full-text refetch queued. Refresh this event after the task finishes.",
  backfillArticleFailed: "Could not queue the full-text refetch.",
  ...
  backfillFulltext: "Backfill short articles",
  ...
  backfillFulltextHelp: "Refetch full article bodies for saved items that only contain feed summaries.",
...
const zh: UiText = {
  ...
  noArticle: "未选择文章。",
  noEventsTitle: "暂无事件",
  noEventsDescription: "先点击“采集全部来源”或“补采热门事件”，再点击“聚类新文章”，系统会生成可分析事件。",
  noEventsFiltered: "没有匹配事件，请清空搜索或筛选条件再试。",
  noEventSelected: "请选择一个事件查看本站分析和来源报道。",
  noArticlesTitle: "这个事件暂时没有关联报道",
  noArticlesDescription: "请先运行“补采热门事件”或“聚类新文章”，任务完成后刷新事件即可看到报道。",
  source: "原始链接",
  sourceAgency: "新闻机构",
  sourceCountry: "所属国家",
  sourceRegion: "地区",
  ...
  backfillThisArticle: "补全这篇正文",
  backfillArticleQueued: "已加入正文补全队列。任务完成后刷新这个事件即可看到更新。",
  backfillArticleFailed: "正文补全任务提交失败，请检查后端服务。",
  ...
  noDisputes: "未检测到矛盾。",
  blindSpots: "报道盲区",
  blindSpotHelp: "作用：标出只有少数新闻机构提到、其他来源没有充分覆盖的事实线索。它用于提醒你重点核验，不代表这条信息一定为假。",
  noBlindSpots: "未发现报道盲区。",
  ...
  backfillFulltextHelp: "重新抓取已保存但只有摘要的文章正文，成功后会更新本站分析。",
